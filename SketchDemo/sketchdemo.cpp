...
MainWindow::MainWindow()
{
	...
	if (value & NID_INTEGRATED_PEN){
		MessageBoxW(hWnd, L"Pen found", L"IsPen!", MB_OK);	
	}

	/* enable ink collector? never got to test if this does anything,
	it does account for the black lines that show up while drawing */
	HRESULT hr;
